...
describe("Spoken Calling presentation and completion", () => {
  ...
  it.each(["okay terima kasih", "baik itu sahaja", "dah cukup", "okay bye", "terima kasih ya"])("closes genuine completion: %s", transcript => {
  ...
  it.each(["Terima kasih, saya nak tanya satu lagi", "Okay terima kasih, berapa harga pakej?", "Jangan putuskan talian dulu", "Saya nak putuskan tempahan umrah saya"])("keeps an active conversation open: %s", transcript => {
